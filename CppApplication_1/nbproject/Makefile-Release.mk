...
${OBJECTDIR}/ConstructorPolinomio.o: ConstructorPolinomio.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ConstructorPolinomio.o ConstructorPolinomio.cpp

${OBJECTDIR}/Evaluador.o: Evaluador.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Evaluador.o Evaluador.cpp

${OBJECTDIR}/Mapeo.o: Mapeo.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Mapeo.o Mapeo.cpp

${OBJECTDIR}/Monomio.o: Monomio.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Monomio.o Monomio.cpp
...
${OBJECTDIR}/ConstructorPolinomio_nomain.o: ${OBJECTDIR}/ConstructorPolinomio.o ConstructorPolinomio.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ConstructorPolinomio_nomain.o ConstructorPolinomio.cpp;\
	else  \
...
${OBJECTDIR}/Evaluador_nomain.o: ${OBJECTDIR}/Evaluador.o Evaluador.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Evaluador_nomain.o Evaluador.cpp;\
	else  \
...
${OBJECTDIR}/Mapeo_nomain.o: ${OBJECTDIR}/Mapeo.o Mapeo.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Mapeo_nomain.o Mapeo.cpp;\
	else  \
...
${OBJECTDIR}/Monomio_nomain.o: ${OBJECTDIR}/Monomio.o Monomio.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Monomio_nomain.o Monomio.cpp;\
	else  \
...
${OBJECTDIR}/Polinomio_nomain.o: ${OBJECTDIR}/Polinomio.o Polinomio.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Polinomio_nomain.o Polinomio.cpp;\
	else  \
